      ...
      <div className="flex h-full items-center justify-between px-4 lg:px-6">
        ...
        <Link href="/dashboard" className="flex items-center gap-2">
          <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-primary/10 p-1.5">
            <Image src="/logo.svg" alt="sangram" width={28} height={28} className="dark:invert-0" />
          </div>
        ...
        <nav className="hidden md:flex items-center gap-1">
          <Link
            href="/dashboard"
            className="px-4 py-2 rounded-lg text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-slate-100 dark:hover:bg-white/5 transition-colors"
          >
            Dashboard
          </Link>
          <Link
